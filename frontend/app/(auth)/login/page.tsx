...
export default function LoginPage() {
    return (
        <div className="min-h-screen flex flex-col justify-center items-center px-4 py-12 bg-slate-50 dark:bg-slate-950 transition-colors duration-200">
            ...
            {/* Suspense boundary wrapping the component using useSearchParams */}
            <Suspense fallback={
                <div className="w-full max-w-md p-8 bg-white dark:bg-slate-900 rounded-3xl shadow-xl flex items-center justify-center min-h-[300px]">
